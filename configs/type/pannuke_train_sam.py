data_root = "/data1/hounaiqiao/SpatioCell/datasets/type/pannuke/preprocessed/"
test_image_dir = "/data1/hounaiqiao/yy/NucleiSeg/benchmark/data/pannuke/fold3/image/"
test_label_dir = "/data1/hounaiqiao/yy/NucleiSeg/benchmark/data/pannuke/fold3/label/"
work_dir = "/data1/hounaiqiao/SpatioCell/work_dirs/type/pannuke/train-sam/"

num_classes = 6

hf_sam_pretrain_ckpt_path = "checkpoints/sam-vit-huge/pytorch_model.bin"
...
train_pipeline = [
    ...
    dict(
        ...
        min_area=0,
        fix_mirror=True,  # Ture if using mirror in patch extraction
    ),
...
evaluation = dict(interval=1, metric=["mIoU", "mDice"], by_epoch=True)
