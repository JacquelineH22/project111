...
work_dir = "/data1/hounaiqiao/SpatioCell/work_dirs/type/pannuke/train-prompt/"

num_classes = 6

hf_sam_pretrain_ckpt_path = "/data1/hounaiqiao/SpatioCell/work_dirs/type/pannuke/train-sam/latest.pth"
