...
from copy import deepcopy     # 用于创建配置的深拷贝
...
def run_test_with_cfg(cfg, **kwargs):
    ...
    if rank == 0:
        ...
        if args.eval:
            ...
            if 'DICE' in eval_results.keys():
                score = eval_results['DICE']
            elif 'bPQ' in eval_results.keys():
                score = eval_results['bPQ']

            return score, eval_results
