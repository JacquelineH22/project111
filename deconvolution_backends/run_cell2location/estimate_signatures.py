...
if __name__ == '__main__':
    ...
    mtx_dir = '/data1/hounaiqiao/yy/NucleiSeg/benchmark_review/interval/data/luca/sc_reference_12.h5ad'
    save_dir = '/data1/hounaiqiao/yy/NucleiSeg/cell2location/outs/luca/reference_signatures'

    # load data
    # adata_sc = read_sc(mtx_dir)
    adata_sc = sc.read_h5ad(mtx_dir)
