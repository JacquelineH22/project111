...
if __name__ == '__main__':
    ...
    st_h5_file = '/data1/hounaiqiao/wzr/Simulated_Xenium/luca/w55/simulated_square_spot_data.h5ad'
    ref_dir = 'outs/luca/reference_signatures'
    save_dir = 'outs/luca/w55_mapping_results'

    # load data
    with warnings.catch_warnings():
        warnings.simplefilter("ignore")
        adata_st = sc.read_h5ad(st_h5_file)
